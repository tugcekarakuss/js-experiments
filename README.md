...
| <img src="./todo-filter/project-preview.gif" width="120"/> | **[Todo Filter](./todo-filter/)** | A simple todo application that allows users to add tasks, mark them as completed, and filter the list by all, active, or completed items. Focuses on DOM manipulation, event handling, and conditional rendering using vanilla JavaScript. | — | — |
...
| <img src="./job-application-tracker/project-preview.gif" width="120"/> | **[Job Application Tracker](./job-application-tracker/)** | A job application tracking application with dynamic filtering and sorting features. Includes centralized filter state management, real-time UI updates, and separation of state, filtering logic, and rendering logic. Built with vanilla JavaScript, focusing on state-driven UI, array methods, and DOM manipulation. | — | — |
| <img src="./github-profile-viewer/images/project-preview.png" width="120"/> | **[GitHub Profile Viewer](./github-profile-viewer/)** | A GitHub profile viewer application that fetches user data and repositories using the GitHub REST API. Includes dynamic rendering, loading and error state handling, input validation, and real-time UI updates. Built with vanilla JavaScript, focusing on asynchronous operations, API integration, and DOM manipulation. | [Live](https://github-profile-viewerrrr.netlify.app/) | — |
